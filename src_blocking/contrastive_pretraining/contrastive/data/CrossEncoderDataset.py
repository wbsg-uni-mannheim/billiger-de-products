...
class CrossEncoderDataset(torch.utils.data.Dataset):
    def __init__(self, path, dataset_type, size=None, tokenizer='huawei-noah/TinyBERT_General_4L_312D', max_length=256,
        ...
        if self.dataset_type != 'test':
            if dataset == 'wdcproducts80cc20rnd050un':
                validation_ids = pd.read_csv('data/blocking/products80cc20rnd_050un/products80cc20rnd_050un-valid.csv')
            elif dataset == 'wdcproducts80cc20rnd000un':
                validation_ids = pd.read_csv('data/blocking/products80cc20rnd_050un/products80cc20rnd_000un-valid.csv')
    ...
    def _prepare_data(self, data):
        ...
        if self.dataset == 'abt-buy':
            ...
            data['features'] = data.apply(self.serialize_sample_product, axis=1)
    ...
    def serialize_sample_product(self, sample):
