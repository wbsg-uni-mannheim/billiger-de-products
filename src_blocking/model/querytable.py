...
def get_gt_tables(type, schema_org_class):
    ...
    gt_tables = []
    path_to_gt_tables = 'data/querytables/{}/{}/'.format( schema_org_class, type)
...
def get_query_table_paths(type, schema_org_class, gt_table, switched=False):
    ...
    if switched:
        ...
        path_to_query_tables = '{}/querytables/{}/{}/{}/'.format(os.environ['DATA_DIR'], schema_org_class, type, schema_org_class)
        print(path_to_query_tables)
