...
from src_blocking.strategy.retrieval.query_by_entity import QueryByEntity
from src_blocking.strategy.retrieval.combined_retrieval_strategy import CombinedRetrievalStrategy
from src_blocking.strategy.retrieval.query_by_goldstandard import QueryByGoldStandard
from src_blocking.strategy.retrieval.query_by_neural_entity import QueryByNeuralEntity
from src_blocking.strategy.retrieval.query_by_table import QueryByTable
from src_blocking.strategy.retrieval.retrieval_strategy import RetrievalStrategy
from src_blocking.strategy.retrieval.query_by_faiss import QueryByFaiss
...
def select_retrieval_strategy(retrieval_strategy, dataset, clusters, switched=False):
    ...
    elif strategy_name == 'query_by_faiss':
        strategy_obj = QueryByFaiss(
            dataset=dataset,
            embedding_dir=retrieval_strategy['embedding_dir'],
            faiss_index_path=retrieval_strategy['faiss_index'],
            clusters=clusters,
            switched=switched
        )
    else:
