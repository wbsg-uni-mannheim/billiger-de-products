...
for category in products20cc80rnd000un products50cc50rnd000un products80cc20rnd000un; do
  for size in small medium large; do
    python -u src/models/r-supCon/run_finetune_siamese.py \
      --model_pretrained_checkpoint "results/generated/r-supcon/en/pretrain/${category}-${size}" \
      --do_train \
      --do_eval \
      --do_predict \
      --frozen=False \
      ...
      --output_dir "results/generated/r-supcon/en/finetune/${category}-${size}/" \
