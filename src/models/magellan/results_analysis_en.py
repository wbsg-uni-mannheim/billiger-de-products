...
def magellan_results_analysis():
    ...
    cc_records = []
    for jf in glob.glob("data/efficiency_tracker/magellan_en/*.json"):
        ...
        for rec in data:
            ...
            m = re.search(
                r"learning-curve_([A-Za-z0-9]+)_run(\d+)_testset=([^=]*?\.csv)_trainset=([^=]*?\.csv)",
                job
            )
    ...
    for cf in glob.glob("src/models/magellan/model_output_en/reports/learning-curve/*.csv", recursive=True):
    ...
    out = Path("src/models/magellan/model_output_en/analysis/magellan_experiment_summary_en.xlsx")
...
def analyse_confidence_curves(prediction_glob_pattern):
    ...
    best_f1_final = recompute_and_save(
        ...
        "src/models/magellan/model_output_en/analysis/best_thresholds_f1.csv"
    )

    best_total_final = recompute_and_save(
        best_total,
        prediction_glob_pattern,
        "src/models/magellan/model_output_en/analysis/best_thresholds_total_f1_ge_0_9.csv"
    )
...
def categories():
    ...
    column_path = "data/processed_en/magellan/learning-curve"
    predictions_path = "src/models/magellan/model_output_en/predictions/magellan/learning-curve/*.csv"
    ...
    os.makedirs("src/models/magellan/model_output_en/analysis/categories", exist_ok=True)
    category_analysis_df.to_csv("src/models/magellan/model_output_en/analysis/categories/category_analysis_en.csv", index=False)
    ...
    category_summary.to_excel("src/models/magellan/model_output_en/analysis/categories/category_summary_en.xlsx", index=False)
        

def categories_of_best_models():
    category_path= "src/models/magellan/model_output_en/analysis/categories/category_summary_en.xlsx"
    model_results_path = "src/models/magellan/model_output_en/analysis/magellan_experiment_summary_en.xlsx"
    ...
    category_analysis.to_excel("src/models/magellan/model_output_en/analysis/categories/category_analysis_best_models_en.xlsx", index=False)
...
if __name__ == "__main__":
    ...
    #    "src/models/magellan/model_output_en/predictions/magellan/learning-curve/*.csv"
    #)
    categories()
