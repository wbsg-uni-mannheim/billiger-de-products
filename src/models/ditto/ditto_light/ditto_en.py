...
def train(trainset, validset, testset, testset050, testset100, run_tag, hp, path):
    ...
    for epoch in range(1, hp.n_epochs+1):
        ...
        if (epoch == hp.n_epochs):
            path = "src/models/ditto/output_en/" + str(run_tag) + '.txt'
            ...
            path_predictions = "src/models/ditto/output_en/prediction/" + str(run_tag) + '_predictions.csv'
            creat_pred_csv(path_predictions, best_test_preds)
            path_predictions_050 = "src/models/ditto/output_en/prediction/" + str(run_tag) + '_predictions_050.csv'
            creat_pred_csv(path_predictions_050, best_test_preds_050)
            path_predictions_100 = "src/models/ditto/output_en/prediction/" + str(run_tag) + '_predictions_100.csv'
