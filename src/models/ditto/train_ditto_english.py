...
from ditto_light.ditto_en import train
...
if __name__=="__main__":
    ...
    parser.add_argument("--logdir", type=str, default="src/models/ditto/checkpoints_en/")
    ...
    run_tag = '%s_lm=%s_da=%s_dk=%s_su=%s_size=%s_id=%d_english' % (hp.task, hp.lm, hp.da,
                hp.dk, hp.summarize, str(hp.size), hp.run_id)
    run_tag = run_tag.replace('/', '_')

    # load task configuration
    configs = json.load(open('src/models/ditto/configs_en.json'))
